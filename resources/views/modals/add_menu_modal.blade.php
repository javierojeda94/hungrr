  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        {!! Form::hidden('id', '', ['id' => 'restaurant-id','class' => 'restaurant-id']) !!}
            {!! Form::text('name', '', ['id' => 'name','class' => 'form-control',  'placeholder'=>'p.e: Menú regular, menú de niños, etc.', 'style'=>'width:100%;']) !!}
        </div>
